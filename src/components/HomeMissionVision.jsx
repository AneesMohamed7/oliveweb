    ...
    return (
        ...
        >
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                {/* ── PURPOSE HERO — Image + text side-by-side ── */}
                <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center mb-20">
                    ...
                    >
                        <div className="rounded-3xl overflow-hidden shadow-2xl shadow-primary/10">
                            <img
                                ...
                                alt="Dentist at Olive Dental consulting with a family in Kondotty"
                        ...
                        <div className="absolute -top-6 -left-6 w-28 h-28 rounded-full border-4 border-primary/10 -z-10 hidden lg:block" />
                    </motion.div>
                    ...
                    >
                        ...
                        <p className="text-gray-500 text-sm leading-relaxed mb-6">
                            Many advanced dental procedures were once only accessible in larger cities. We changed that by
                            bringing comprehensive multi-specialty care under one roof — supported by modern diagnostics,
                            specialist doctors, and a commitment to transparent, ethical practice.
                        </p>
                        {/* Quick stats row */}
                ...
                {/* Main two-column layout — Mission & Vision */}
                <div className="grid lg:grid-cols-2 gap-6 mb-10">
                    ...
                    <motion.div
                        ...
                        variants={fadeUp}
                        custom={0.1}
                        className="group relative bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:border-primary/20 transition-all duration-500 overflow-hidden"
                    >
                        {/* Accent bar */}
                        ...
                        <div className="h-44 overflow-hidden relative">
                            <img
                                src="/images/mission-technology.png"
                                alt="Advanced dental technology and equipment at Olive Dental Clinic"
                    ...
                    <motion.div
                        ...
                        variants={fadeUp}
                        custom={0.2}
                        className="group relative bg-gray-900 rounded-3xl shadow-sm hover:shadow-2xl transition-all duration-500 overflow-hidden text-white"
                    >
                        {/* Vision image */}
                        <div className="h-44 overflow-hidden relative">
                            <img
                                src="/images/vision-clinic-future.png"
                                alt="Modern, welcoming Olive Dental clinic interior"
                                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                                loading="lazy"
                            />
                        ...
                        <div className="p-8 lg:p-10 pt-4">
                            ...
                            {/* Vision statement */}
                            <p className="text-gray-300 leading-relaxed mb-5 text-[15px] relative z-10">
