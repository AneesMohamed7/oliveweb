...
import { Smile, Anchor, Users, Sparkles } from 'lucide-react';
        ...
        <section className="py-24 bg-gray-900 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="grid md:grid-cols-3 gap-12 md:gap-8">
                    <Counter from={0} to={500} label="Aligners Delivered" icon={Smile} delay={0} />
                    <Counter from={0} to={1200} label="Dental Implants" icon={Anchor} delay={0.2} />
                    <Counter from={0} to={5000} label="Happy Patients" icon={Users} delay={0.4} />
                </div>
            </div>
        </section>
    );
