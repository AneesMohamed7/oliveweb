                        ...
                        <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 0.2 }} className="relative">
                            <div className="rounded-3xl overflow-hidden shadow-2xl shadow-primary/10 border border-gray-100">
                                <img
                                    ...
                                    alt="Dental crown restoration at Olive Dental"
                    ...
                    <div className="grid lg:grid-cols-2 gap-14 items-center">
                        <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
                            <img
                                ...
                                alt="Dental crown fitting procedure"
                ...
                <div className="max-w-3xl mx-auto px-4">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                        ...
                        <p className="text-xl text-blue-100 mb-10 max-w-xl mx-auto">
                            Book a consultation — we'll examine your tooth, explain your options, and give you a clear treatment plan with no obligations.
                        </p>
